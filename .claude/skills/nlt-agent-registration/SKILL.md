...
This skill guides agents through completing the **agent self-registration** record required by ORG-DEV-OTOI-1.0.3 Section 3 at the start of every NLT session.
