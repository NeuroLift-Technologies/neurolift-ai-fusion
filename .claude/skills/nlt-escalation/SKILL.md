...
This skill guides agents through creating a complete **escalation record** as defined in ORG-DEV-OTOI-1.0.3 Section 4.3. Escalation is not failure — it is correct protocol.
