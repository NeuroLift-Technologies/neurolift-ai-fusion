...
This skill guides agents through writing a complete **session handoff record** as required by ORG-DEV-OTOI-1.0.2 Section 5. A handoff record must be written at the end of every significant session.
