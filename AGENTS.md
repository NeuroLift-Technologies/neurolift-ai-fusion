...
| `.github-private/NLT-DEV-OTOI.md` (source repo) | Upstream governance source used by sync automation |
...
1. Read `NLT-DEV-OTOI.md` (repo root). If unavailable, request a governance sync from `.github-private`.
