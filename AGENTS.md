# AGENTS.md — NeuroLift Technologies neurolift-ai-fusion Repository Agent Gateway

> **Internal use only.** This is the repository-specific governance gateway for coding agents operating in this repository. This copy is scoped to NeuroLift-Technologies/neurolift-ai-fusion, with project-specific operational context kept in this repository.
...
> **Repo-local note:** Governance docs in this repository are the working copy for NeuroLift-Technologies/neurolift-ai-fusion. Keep references local unless Joshua explicitly asks for an upstream sync.
...
- Repo-local governance context: [NeuroLift-Technologies/neurolift-ai-fusion](https://github.com/NeuroLift-Technologies/neurolift-ai-fusion)
...
All files below live in this repository (`NeuroLift-Technologies/neurolift-ai-fusion`):

```
NLT-DEV-OTOI.md                        ← Repo-local agent contract
AGENTS.md                               ← This file
CLAUDE.md                               ← Repo-specific agent entrypoint
nltotoi.json                            ← Discovery manifest
package.json                            ← Workspace scripts / monorepo entry
requirements.txt                        ← Root Python dependency set
wrangler.toml                           ← Cloudflare runtime config
wrangler.jsonc                          ← Cloudflare config variant
...
docs/
├── active-threads.md                   ← Live coordination baton board
└── agent-log/
    ├── README.md                       ← Agent log usage guide
    ├── registrations/                  ← Section 3 self-registration records
    └── handoffs/                       ← Section 5 handoff records
...
packages/
└── simulation-sdk/                     ← Shared simulation package
